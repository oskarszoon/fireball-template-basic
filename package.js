Package.describe({
    name: 'fireball:template-basic',
    version: '0.0.1',
    // Brief, one-line summary of the package.
    summary: 'Fireball Template: Bootstrap basic',
...
Package.onUse(function (api) {
    ...
    api.addFiles('fireball:template-basic.js');
...
Package.onTest(function (api) {
    api.use('tinytest');
    api.use('fireball:template-basic');
    api.addFiles('fireball:template-basic-tests.js');
});
